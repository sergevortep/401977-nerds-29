...
* Студент: [SERGE VORTEP](https://up.htmlacademy.ru/htmlcss/29/user/401977).
* Наставник: `Прохожу курс повторно. Наставника нет!`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/401977-nerds-29) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
